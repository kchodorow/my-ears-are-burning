...
public class AccessTokenServlet extends HttpServlet {
  ...
  private final SecretDatastore datastore = new SecretDatastore();
  ...
  private void requestToken(HttpServletRequest request)
    throws IOException {
    // TODO: check state.
